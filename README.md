...
### 🚀 Sobre Mim
- 💡 Possuo conhecimento sólido em **Desenvolvimento Backend**, **C#** e **arquitetura de software**  
- 🧠 Experiência com **.NET**, **Entity Framework** e **APIs REST**  
- 🧩 Habilidade em **levantamento de requisitos**, **desenho de APIs** e **estruturação de projetos**  
- ⚙️ Trabalho com banco de dados **SQL Server** e **PostgreSQL**
- 🧰 Familiaridade com versionamento de código com **Git** e **Github**
- 📚 Busco sempre aprimorar meus conhecimentos e explorar novas tecnologias
...
### 🗄️ Bancos de Dados  
<img src="https://skillicons.dev/icons?i=mysql,postgresql&perline=6" />
...
- 🩺 **senhasegura** — Projeto desenvolvido com C#, HTML, CSS e Javascript para para a verificação e validação de senhas, garantindo que atendam aos requisitos de segurança definidos
- 🤖 **Cofrinho** —   API desenvolvida para a organização e armazenamento seguro de senhas por meio de cofres personalizados criados conforme a necessidade do usuário
---
